...
export default function AdminLayout({ children }) {
  ...
  const navItems = [
    ...
    { path: "/admin/universities", icon: "🎓", label: "Universidades" },
    { path: "/admin/jobs", icon: "💼", label: "Trabajos" },
    { path: "/admin/mentorships", icon: "🤝", label: "Mentorías" },
    { path: "/admin/communities", icon: "💬", label: "Comunidades" },
    { path: "/admin/cvs", icon: "📄", label: "CVs" },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 text-white transform transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:inset-auto`}>
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div className="p-6 border-b border-gray-800">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
                <span className="text-gray-900 font-bold text-xl">TB</span>
              </div>
              <div>
                <h1 className="text-xl font-bold">Admin Panel</h1>
                <p className="text-gray-400 text-xs">TalentBridge Management</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 border-t border-gray-800">
            <button
              ...
              className="flex items-center justify-center w-full space-x-2 px-4 py-3 bg-red-900/30 hover:bg-red-900/50 text-red-300 hover:text-white rounded-lg transition-colors"
            >
          ...
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center space-x-4">
              ...
              <nav className="hidden md:flex items-center space-x-2 text-sm text-gray-600">
                <Link to="/admin/dashboard" className="hover:text-gray-900">Admin</Link>
                <span>/</span>
